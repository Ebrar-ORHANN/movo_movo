...
const {
  ...
  loading, activeTab, setActiveTab, totalKm, logout, reload, // ← reload ekle
} = useProfile();
  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={() => Alert.alert('QR Kod', 'Yakında!')}>
      ...
      <View style={styles.actions}>
        {/* ✅ Artık /profile/edit'e yönlendiriyor */}
        <TouchableOpacity
        ...
        <TouchableOpacity
          ...
          onPress={() => Alert.alert('Paylaş', 'Yakında!')}
        >
      ...
      <View style={styles.scoreCard}>
        ...
        <Text style={styles.scoreValue}>
          {profile?.participation_score?.toLocaleString('tr-TR') || '0'}
        </Text>
      ...
      <View style={styles.section}>
        ...
        {[
          { icon:'create-outline',       label:'Profili Düzenle',        onPress: () => router.push('/profile/edit') },
          { icon:'lock-closed-outline',  label:'Gizlilik',               onPress: () => router.push('/profile/edit') },
          ...
          ...(adminPerms?.is_admin
            ? [{ icon:'shield-outline', label:'Admin Paneli', onPress: () => router.push('/admin/index'), isAdmin: true }]
            : []),
        ].map((item, i) => (
        ...
        <TouchableOpacity
          style={[styles.settingRow, { borderTopWidth:0.5, borderTopColor:'#2A2A2A', marginTop:8 }]}
